...
def coupled_flux_qubit_pot(phi_1, phi_2, phi_1dc, phi_2dc, params, phi_1_prefactor = 1, phi_2_prefactor = 1):
    ...
    u5 = M_12 / (L_1 * L_2) * (phi_1 - phi_1x) * (phi_2 - phi_2x)
...
coupled_fq_default_param = np.array(coupled_fq_default_param).reshape(1, -1)
...
coupled_fq_pot = Potential(coupled_flux_qubit_pot, coupled_flux_qubit_force, 12, 4, default_params = coupled_fq_default_param,  relevant_domain = coupled_fq_domain)
